...
public class JwtTokenGenerator : IJwtTokenGenerator
{
    ...
    public string GenerateAccessToken(dynamic user, IList<string> roles)
    {
        ...
        var expires = DateTime.UtcNow.AddHours(double.Parse(_configuration["JwtSettings:ExpirationInHours"]!));
